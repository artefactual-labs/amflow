...
func MountSchemaController(service *goa.Service, ctrl SchemaController) {
	initService(service)
	var h goa.Handler
	service.Mux.Handle("OPTIONS", "/schema/*filepath", ctrl.MuxHandler("preflight", handleSchemaOrigin(cors.HandlePreflight()), nil))
...
func MountWebController(service *goa.Service, ctrl WebController) {
	...
	h = ctrl.FileHandler("/*filepath", "public/web/")
	h = handleWebOrigin(h)
	service.Mux.Handle("GET", "/*filepath", ctrl.MuxHandler("serve", h, nil))
	service.LogInfo("mount", "ctrl", "Web", "files", "public/web/", "route", "GET /*filepath")

	h = ctrl.FileHandler("/", "public/web/index.html")
	h = handleWebOrigin(h)
	service.Mux.Handle("GET", "/", ctrl.MuxHandler("serve", h, nil))
	service.LogInfo("mount", "ctrl", "Web", "files", "public/web/index.html", "route", "GET /")
}
